...
class RidehailDriverTripStateMachine(StateMachine):
    ...
    # ready = driver_cancelled_trip.to(driver_available) | driver_completed_trip.to(driver_available)
    ...
    # move_to_pickup = driver_accepted_trip.to(driver_moving_to_pickup)
    passenger_confirmed_trip = driver_accepted_trip.to(driver_moving_to_pickup)
    # wait_to_pickup = driver_accepted_trip.to(driver_waiting_to_pickup) | driver_moving_to_pickup.to(driver_waiting_to_pickup)
    ...
    # pickup = driver_pickedup.from_(driver_accepted_trip, driver_moving_to_pickup, driver_waiting_to_pickup)
    # passenger_acknowledge_pickup = driver_pickedup.from_(driver_moving_to_pickup, driver_waiting_to_pickup)
    ...
    # dropoff = driver_moving_to_dropoff.to(driver_droppedoff) | driver_waiting_to_dropoff.to(driver_droppedoff)
