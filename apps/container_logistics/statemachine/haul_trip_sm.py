...
class HaulTripStateMachine(StateMachine):
    ...
    # Compatibility: avoid `State | State` union, use from_ for multi-source transitions.
    arrive_pickup_queue = queued_for_pickup.from_(assigned, repositioning_to_pickup)
