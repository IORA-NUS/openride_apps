...
haultrip_gate_interactions = [
    {
        ...
        "description": "Truck joins the facility gate queue (pickup visit)",
    },
    {
        "source_statemachine": GateStateMachine.__name__,
        "source_transition": GateStateMachine.assign_truck.name,
        "source_new_state": GateStateMachine.busy.name,
        "action": ContainerLogisticsActions.FACILITY_WORKFLOW_EVENT,
        ...
        "description": "Facility assigns gate slot for pickup visit",
    },
    {
        "source_statemachine": GateStateMachine.__name__,
        ...
        "description": "Facility service completes and haul trip departs loaded",
    },
    {
        "source_statemachine": HaulTripStateMachine.__name__,
        ...
        "target_statemachine": GateStateMachine.__name__,
        "target_new_state": GateStateMachine.available.name,
        "description": "Truck joins the facility gate queue (dropoff visit)",
    },
    {
        "source_statemachine": GateStateMachine.__name__,
        "source_transition": GateStateMachine.assign_truck.name,
        ...
        "description": "Facility assigns gate slot for dropoff visit",
    },
    {
        "source_statemachine": GateStateMachine.__name__,
        "source_transition": GateStateMachine.complete_service.name,
        ...
        "description": "Facility service completes and haul trip completes",
    },
]
