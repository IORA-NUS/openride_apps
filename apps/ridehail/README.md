...
- `apps.ridehail.driver` -> exports `DriverApp`, `DriverAgentIndie`, `DriverManager`, `DriverTripManager`
- `apps.ridehail.passenger` -> exports `PassengerApp`, `PassengerAgentIndie`, `PassengerManager`, `PassengerTripManager`
- `apps.ridehail.assignment` -> exports `AssignmentApp`, `AssignmentAgentIndie`
- `apps.ridehail.analytics` -> exports `AnalyticsApp`, `AnalyticsAgentIndie`
...
1. Keep existing folder paths; import shared contracts from `apps/ridehail`.
2. Add adapter layers under `apps/ridehail/adapters/` for each role.
...
- `apps/ridehail/driver/`
- `apps/ridehail/passenger/`
- `apps/ridehail/assignment/`
- `apps/ridehail/analytics/`
